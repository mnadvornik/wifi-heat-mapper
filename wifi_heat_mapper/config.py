from wifi_heat_mapper.misc import TColor, check_application, process_wireless_metrics, save_json, get_application_output
...
def start_config(config_file):
    ...
    while True:
        ...
        if system == "Darwin":
            print("Code for Darwin")
            results = process_wireless_metrics(target_interface)

            print("Results from process_wireless_metrics:")
            print(results)
    ...
    while True:
        ssid = process_wireless_metrics(target_interface)["ssid"]
